...
create table note_snapshots (
  ...
  related_school_date text not null,
  ...
  check (related_context_type = 'school_date'),
  check (related_period_number is null),
  check (related_task_item_id is null)
);
...
insert into shared_information_items_new (
  ...
  current_note_snapshot_id, created_by_student_account_id, created_at,
  removed_at
)
select shared_information_item_id, kind, target_scope_id, latest_change_id,
       current_task_snapshot_id, current_timetable_change_snapshot_id,
       null, created_by_student_account_id, created_at, removed_at
...
insert into shared_information_changes_new (
  ...
  timetable_change_snapshot_id, note_snapshot_id
)
